...
class FFNRelu(nn.Module):
    def __init__(self, in_dim, hidden_dim, out_dim = None, device = 'cpu'):
...
class FFNet(nn.Module):
    def __init__(self, nonlinearity, in_dim, hidden_dim, out_dim = None, device = 'cpu'):
