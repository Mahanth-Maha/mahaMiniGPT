...
def main():
    ...
    from nlp.tokenizer import CharTokenizer
    ...
    if not chars_exists:
        logger_transformer.info("Loading Data & Getting chars...")
        chars = tokenizer.train(args.data_file)
        logger_transformer.info("✅ Data Loaded and chars saved!")
    else:
        chars = tokenizer.load()
    ...
    if os.path.exists(args.encoding_file):
        ...
        logger_transformer.info("Encoding not found! Loading Data... to encode")
