...
class SingleHeadSelfAttention(nn.Module):
    def __init__(self, model_dimension, head_size, context_length,  dropout = 0.7, device = 'cpu'):
        super().__init__()
        ...
        self.q = nn.Linear(self.model_dimension, self.head_size , bias=False, device=self.device)
        self.k = nn.Linear(self.model_dimension, self.head_size , bias=False, device=self.device)
        self.v = nn.Linear(self.model_dimension, self.head_size , bias=False, device=self.device)
