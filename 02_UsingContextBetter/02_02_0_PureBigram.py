...
from nlp.NgramModel import NGramLanguageModel
...
# bi-gram model
model = NGramLanguageModel(vocab_size , BLOCK_SIZE,N_EMBEDDINGS,DEVICE ,n_gram=args.n_gram)
