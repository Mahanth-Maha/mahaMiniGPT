...
---------------------------------           ONGOING            ---------------------------------
    ...
    Solution ::  initialize embeddings carefully (e.g. GPT2 std=0.02) 
                 apply a scaling factor in the forward pass (e.g. GPT2 div by sqrt(n_embeddings)) 
...
class DecoderOnlyTransformer(nn.Module):
    ...
    def __init__(self, vocab_size, context_length, n_embeddings, n_heads, Nx, ffn_hid_dim = None, non_linearity ='gelu', dropout = 0.7, device = 'cpu'):
        ...
        self.lm_head = nn.Linear(self.n_embeddings, self.vocab_size, bias= False,device=self.device)
