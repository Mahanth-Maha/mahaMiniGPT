...
from nlp.SRBlockPreLayerNormwDropouts import NGramSRBlocksPreLNwDP
...
model = NGramSRBlocksPreLNwDP(
    ...
    device=DEVICE,
    nonlinearity=args.non_linearity,
    n_gram=args.n_gram,
    )
