model_name = '02_02_1_Average_ctx'
'''
...
from nlp.NgramAvgContext import NGramAverageContext
...
# bi-gram model
model = NGramAverageContext(vocab_size , BLOCK_SIZE,N_EMBEDDINGS,DEVICE ,n_gram=args.n_gram)
