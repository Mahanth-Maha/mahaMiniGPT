model_name = '05_03_1_post_LayerNorm'
'''
In this script, Adding Projections in all MHSA, FFN's 
'''
...
from nlp.SRBlockPostLayerNorm import NGramSRBlocksPostLN
