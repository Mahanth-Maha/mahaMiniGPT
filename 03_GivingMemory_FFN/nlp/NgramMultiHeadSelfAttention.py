...
from .NgramSelfAttention import SingleHeadAttention, SingleHeadAttentionwDropout
...
class MHSAwProj(nn.Module):
    def __init__(self, n_heads,n_embs , head_size, block_size, vocab_size, device = 'cpu'):
        super(MHSAwProj, self).__init__()
        self.n_heads = n_heads
