...
from nlp.NgramSelfAttention import NGramSelfAttention
...
# bi-gram model
model = NGramSelfAttention(vocab_size , BLOCK_SIZE,N_EMBEDDINGS,DEVICE ,n_gram=args.n_gram)
...
""" 
python 02_02_2_Self_Attention.py --train
"""