...
optimizations DONE:
    ...
    7. Attention Type (Effect: Quality++ )
        - Flash Attention-1 (using this)
        [TODO : NOT DONE YET] - Flash Attention-2 (fused layernorm, Rope, CELoss)
...
def get_args():
    ...
    parser.add_argument("--encoding-file", default='../data/encodings/cl100k_maha_encoding.pth', help="Encoded data file")
