model_name = '06_Transformer'
'''
In this script, Adding Dropouts in all MHSA, FFN's 
'''
...
from nlp.utils import get_metrics
from nlp.DecoderTransformer import DecoderOnlyTransformer
...
def get_args():
    ...
    parser.add_argument("--ffn_hid_dim", type=int, default=512, help="Hidden dimension of FFN")
    ...
    parser.add_argument("--encoding_file", default='./saved_models/encoding.pth', help="Encoded data file")
